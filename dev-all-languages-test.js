  ...
  function renderAllLanguageDeveloperTestPanel(){
    ...
    panel.innerHTML =
      ...
      '<div class="two" style="margin-top:12px">'+
        '<button id="runRepresentativeLanguageTestBtn" class="btn primary w-full" type="button">대표 언어별 테스트 실행</button>'+
        '<button id="runAllCountryLanguageTestBtn" class="btn outline w-full" type="button">전체 국가/지역 테스트 실행</button>'+
      '</div>'+
      '<div id="allLanguageTestStatus" class="notice teal hidden" style="margin-top:12px"></div>'+
      '<div style="overflow:auto;margin-top:12px">'+
        '<table style="width:100%;border-collapse:collapse;min-width:1180px;font-size:12px">'+
          '<thead>'+
            ...
            '</tr>'+
          '</thead>'+
          '<tbody id="allLanguageTestRows"></tbody>'+
        '</table>'+
      '</div>';
